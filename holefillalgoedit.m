%function [holefilledges] = holefillalgo(bdi)         %[vow,cd] 
%function [trsorted] = holefillalgoedit(bdi)
clc 
clear all
close all
impmodel = 'holcylovcy.stl';
%impmodel = 'partforprint.stl';
%impmodel = 'ppwithoneovhnga.stl';
%impmodel = 'dingph.stl';
...
%title('unique  edges')
for i=1:1:size(vow,1)
  plot3 (vow(i,[1 4]),vow(i,[2 5]),vow(i,[3 6]),'b','linewidth',2)
  hold on
end
for i=1:1:size(sortedge,1)
  plot3 (sortedge(i,[1 4]),sortedge(i,[2 5]),sortedge(i,[3 6]),'m','linewidth',2)
  hold on
end
...
title('correct edges')
for i=1:1:size(detedge,1)
  plot3 (detedge(i,[1 4]),detedge(i,[2 5]),detedge(i,[3 6]),'b','linewidth',2)
  hold on
end
...
for i=1:1:size(gapedge,1)
  plot3 (gapedge(i,[1 4]),gapedge(i,[2 5]),gapedge(i,[3 6]),'m','linewidth',2)
  hold on
end
...
for i=1:1:size(filledges,1)
  plot3 (filledges(i,[1 4]),filledges(i,[2 5]),filledges(i,[3 6]),'r','linewidth',2)
  hold on
end
...
for i=1:1:size(holefilledges,1)
  plot3 (holefilledges(i,[1 4]),holefilledges(i,[2 5]),holefilledges(i,[3 6]),'b','linewidth',2)
  hold on
end
